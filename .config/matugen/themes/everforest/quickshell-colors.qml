...
QtObject {
    ...
    readonly property color _onPrimary: "#272e33"
    ...
    readonly property color surfaceDim: "#272e33"
    readonly property color surfaceBright: "#868d80"
    readonly property color surfaceContainerLowest: "#161b1e"
    readonly property color surfaceContainerLow: "#343f44"
