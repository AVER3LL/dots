...
from utils.widget_container import ButtonWidget
...
class BatteryWidget(ButtonWidget):
    ...
    def update_ui(self, *_):
        ...
        adjusted_percentage: int = min(
            100, round((battery_percent / self.full_battery_level) * 100)
        )
        ...
        if self.config.get("label", True):
            ...
            if (
                ...
                and adjusted_percentage >= self.full_battery_level
            ):
