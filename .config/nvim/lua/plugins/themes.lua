                ...
                highlight_overrides = {
                    all = function(colors)
                        return {
                            ...
                            FloatBorder = { bg = colors.base, fg = colors.surface0 }, -- This might be the reason for the clean bgs for floating windows
                            NormalFloat = { bg = colors.base }, -- This too. Maybe base is the default bg color
